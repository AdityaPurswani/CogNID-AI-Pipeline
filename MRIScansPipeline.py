...
class MRIScansPipeline():
    ...
    def image_registration_mni(self, moving_image_path, template_mni_path, output_prefix):
        ...
        # Read images using correct ANTs syntax
            ...
            # Save warped image
            registered_image_path = output_prefix + '_registered.nii.gz'
        ...
        for file in files:
            ...
            if os.path.exists(image_path):
                try:
                    ...
                    features_dict[mri_id][f"{part_name}_Volume"] = volume
                    features_dict[mri_id][f"{part_name}_Surface_Area"] = surface_area
